...
#[no_mangle]
pub extern "C" fn wire_get_default_arch(port_: i64) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap(
        WrapInfo {
            debug_name: "get_default_arch",
            port: Some(port_),
            mode: FfiCallMode::Normal,
        },
        move || move |task_callback| Ok(get_default_arch()),
    )
}

#[no_mangle]
pub extern "C" fn wire_test_strip(port_: i64, id: i32, name: *mut wire_uint_8_list, readed: bool) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap(
        WrapInfo {
            debug_name: "test_strip",
            port: Some(port_),
            mode: FfiCallMode::Normal,
        },
        move || {
            ...
            let api_readed = readed.wire2api();
            move |task_callback| Ok(test_strip(api_id, api_name, api_readed))
        },
    )
}

#[no_mangle]
pub extern "C" fn wire_add(port_: i64, a: u32, b: u32) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap(
        WrapInfo {
            debug_name: "add",
            port: Some(port_),
...
impl support::IntoDart for ArchType {
    fn into_dart(self) -> support::DartCObject {
        match self {
            Self::X86 => vec![0.into_dart()],
            Self::ARM => vec![1.into_dart()],
            Self::MacOs(field0) => vec![2.into_dart(), field0.into_dart()],
        }
        .into_dart()
    }
}
impl support::IntoDartExceptPrimitive for ArchType {}
...
impl support::IntoDart for User {
    fn into_dart(self) -> support::DartCObject {
        vec![
            self.id.into_dart(),
            self.name.into_dart(),
            self.latest_msg.into_dart(),
            self.readed.into_dart(),
            self.avator_url.into_dart(),
        ]
        .into_dart()
    }
}
impl support::IntoDartExceptPrimitive for User {}
